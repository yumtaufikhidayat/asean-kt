...
object CountriesData {
    ...
    private val countryLanguages = arrayOf(
        "Bahasa Indonesia",
        "Thai",
        "Melayu, Inggris, Mandarin",
        "Vietnam",
        "Melayu, Cina, Inggris, Tamil",
        "Lao, Prancis, Inggris",
        "Inggris, Cina, Mandarin, Melayu, Tamil",
        "Burma",
        "Tagalog/Filipino, Inggris",
        "Khmer, Prancis, Inggris"
    )

    private val countryCurrencies = arrayOf(
        "Rupiah (IDR)",
        "Baht (THB)",
        "Dolar Brunei (BND)",
        "Dong (VND)",
    ...
    val listData: ArrayList<Country>
        get() {
            ...
            for (position in countryNames.indices) {
                ...
                country.countryHeadGovernment = countryHeadGovernments[position]
